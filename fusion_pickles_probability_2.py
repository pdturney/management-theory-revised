#
# Fusion Pickles Probability 2 Parts
#
...
#
# row in table = <step number> <prob 2 0> <prob 1 1> <prob 0 2>
#
import golly as g
...
#
graph_file = fusion_dir + "/fusion_pickles_probability_2.txt"
...
for step_num in range(0, num_steps, step_size):
  # initialize counts
  count_2m0w = 0 # 2 managers, 0 workers
  count_1m1w = 0 # 1 manager,  1 worker
  count_0m2w = 0 # 0 managers, 2 workers
  ...
  for seed_num in range(num_seeds):
    ...
    if (manager_count == 2):
      ...
      count_0m2w += 1
  #
  assert count_2m0w + count_1m1w + count_0m2w == num_seeds
  #
  probability_2m0w = count_2m0w / num_seeds
  probability_1m1w = count_1m1w / num_seeds
  probability_0m2w = count_0m2w / num_seeds
  #
  graph_handle.write("{}\t{:.3f}\t{:.3f}\t{:.3f}\n".format(step_num,
    probability_2m0w, probability_1m1w, probability_0m2w))
  #
#
graph_handle.close()
#
